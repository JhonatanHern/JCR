...
<html>
	<head>
		<title>JCR Ingenieros - Historia</title>
	...
	<body>
		...
		<section id="floater">
			...
			<section id="texter">
				<section id="c1"> <?php include 'text_mision.php'; ?></section>
				<section id="c2"> <?php include 'lorem.php'; ?></section>
				<section id="c3" style="display: block;"> <?php include 'text_historia.php'; ?></section>
