...
<html>
	<head>
		<title>JCR Ingenieros - Productos y servicios</title>
	...
	<body>
		...
		<section id="floater">
			...
			<section id="texter">
				<section id="c1" style="display: block;"> <?php include 'text_productos_servicios.php'; ?></section>
				<section id="c2"> <?php include 'text_generacion.php'; ?></section>
				<section id="c3"> <?php include 'text_motores.php'; ?></section>
				<section id="c4"> <?php include 'text_repuestos.php'; ?></section>
